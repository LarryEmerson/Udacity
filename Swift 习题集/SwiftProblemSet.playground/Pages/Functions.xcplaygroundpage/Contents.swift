...
func median(num1:Int,num2:Int,num3:Int)->Int {
    ...
    array.append(num3)
    array.sort();
    print("median:\(array[1])")
    return array[1];
}
//median(num1: 1, num2: 2, num3: 3)
...
func beginsWithVowel(nameOfString:String) ->Bool {
    var vowel=false;
    if(nameOfString.startIndex != nameOfString.endIndex){
        var firstCharacter:Character = nameOfString.characters[nameOfString.startIndex]
        firstCharacter=(String(firstCharacter).lowercased().characters.first)!;
        vowel=vowel||(firstCharacter=="a")
        vowel=vowel||(firstCharacter=="e")
        vowel=vowel||(firstCharacter=="i")
        vowel=vowel||(firstCharacter=="o")
        vowel=vowel||(firstCharacter=="u")
    }
    print(vowel)
//    print(nameOfString + (vowel ? " does " : " doesn't ")+"begin with a vowel")
    return vowel;
}
...
func funWithWords(nameOfString:String) ->String {
    let result = beginsWithVowel(nameOfString: nameOfString) ? nameOfString.uppercased() : nameOfString.lowercased()
    print(result)
    return result
}
