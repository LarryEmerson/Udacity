...
let replacedString=lottaLikes.replacingOccurrences(of: "like", with: "")
...
//desired output = "$5.67"
var money="$\(numOfPennies/100).\(numOfPennies%100)"
print(money)
...
print(weeklyEarningsString.replacingOccurrences(of: "X", with: "\(averageRent/averageMonthlyEarnings)"))
/*:
 ****
 [Table of Contents](Table%20of%20Contents) | [Previous](@previous) | [Next](@next)
 */
